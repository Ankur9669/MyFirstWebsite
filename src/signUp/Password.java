...
public class Password 
{
	...
	public String getHashPassword(String password_plaintext) 
	{
	...
	/*public static void main(String[] args) 
	{
		for (int i = 0; i < 10; i++)
		{
			String hash1 = hashPassword("Ankur");
			String salt1 = salt;
			String check = checkPassword("Ankur", salt1);
			System.out.println("Original hash: " + hash1);
			System.out.println("New hash: " + check);
			if(check.equals(hash1))
			{
